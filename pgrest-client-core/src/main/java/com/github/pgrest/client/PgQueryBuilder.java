...
public class PgQueryBuilder {
    ...
    public PgQueryBuilder copy() { PgQueryBuilder b = new PgQueryBuilder(); b.parts.addAll(this.parts); b.select = this.select; b.order = this.order; b.limit = this.limit; b.offset = this.offset; return b; }
